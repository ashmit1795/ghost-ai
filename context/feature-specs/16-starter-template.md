...
1. Create `components/editor/starter-templates.ts`.
   ...
   - at least 7 templates, such as microservices, CI/CD pipeline, and event-driven system etc. Use a variety of node shapes and colors to show off the editor capabilities.
   - add different types of diagrams like flowcharts, architecture diagrams, mind maps, org charts, sequence diagrams, user stories etc. to show the versatility of the editor
